print("HNk TTF HUB v9.4.3 loading: Full client with admin remote hooks + REP RGB Elite Mode.")
...
-- Single authoritative ESP implementation (require features/esp)
pcall(function()
    local esp = require(script.Parent.Parent:WaitForChild("features"):WaitForChild("esp"))
    if esp and esp.enable and getgenv().HNk and getgenv().HNk.ESP then
        esp.enable()
    end
end)
